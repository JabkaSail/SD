      ...
      function showSlides() {
         ...
         var i = "wallpapers-skyscrapers-018.jpg";
              image1.addEventListener('load', function() {
                    ...
                    $(g).find('#photo').attr('data-image-src', 'imgs/wallpapers-skyscrapers-018.jpg');
                    console.log($(g).find('#photo').attr('data-image-src'));
                    return false;
         ...
         var i = "wallpapers-skyscrapers-023.jpg";
               image2.addEventListener('load', function() {
                ...
                $(g).find('#photo').attr('src', 'imgs/wallpapers-skyscrapers-023.jpg');
        ...
        var i = "9.jpg";
              image3.addEventListener('load', function() {
                    ...
                    $(g).find('#photo').attr('data-image-src', 'imgs/'+i+'');
